const textConfig = {
  text1: "Hola 🤗",
  text2: "Chúc mừng năm mới, chúc cho năm mới của bạn tràn ngập niềm vui, hạnh phúc đong đầy và bình yên thật nhiều. Chúc bạn luôn giữ được nụ cười trên môi kể cả những lúc mệt mỏi hay khó khăn nhé. Happy new year 🥳",
  text3: "C cũng muốn chúc t điều gì đó chứ nhờ :))",
  text4: "Click nghe nhạc bên cạnh đã rồi nhắn 😊😊😊",
  text5: "C chơi đồ à???,đéo chúc lại",
  text6: "Ok để chúc lại",
